...
#import <PhoneGap/InvokedUrlCommand.h>
...
NSString* stringWithJsval(JSContext* jsContext, jsval stringJsval)
{
    ...
    JSContext* cx, JSObject* obj, uintN argc, jsval *argv, jsval *rval)
{
  ...
  NSDictionary* commandObject = [jsonParser objectWithString:commandJSON];
  assert([commandObject isKindOfClass:[NSDictionary class]]);

	[(AppDelegate*)[[UIApplication sharedApplication] delegate]
      execute:[InvokedUrlCommand commandFromObject:commandObject]];
